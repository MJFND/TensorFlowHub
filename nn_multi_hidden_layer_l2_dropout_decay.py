...
with graph.as_default():
  ...
  loss = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(logits, tf_train_labels)+ 0.03 * tf.nn.l2_loss(weights['h1']) + 0.03 * tf.nn.l2_loss(weights['h2'])  + 0.03 * tf.nn.l2_loss(weights['h3']) + 0.03 * tf.nn.l2_loss(weights['out']))
